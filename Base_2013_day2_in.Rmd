...
title: Data Management Plan for the Study 'Do Reputable Open Access Journals Require
  Open Data Sharing'?
author: "Simone Laterza, University of Trieste"
...
This study investigates whether the _most reputable Open Access journals_ have data sharing polices and the characteristics of those policies. These policies require authors, in some fashion, to openly disseminate the data and software underlying their published articles.
...
ggplot(data=doaj, aes(doaj$PubCountry, fill=doaj$PubCountry)) +
  stat_count() +
...
Simone Laterza, Principal Investigator, University of Trieste

## Researcher ID

ORCID: [0000-0002-8971-6608](https://orcid.org/0000-0002-8971-6608)
...
All original data, code, or reports produced as part of this project are owned by Your Institution per its institutional intellectual property policy.

The J. Bohannan Foundation adheres to the open access and data sharing policies of the Gates Foundation https://www.gatesfoundation.org/How-We-Work/General-Information/Open-Access-Policy
...
This data will be read into RStudio, using the tidyverse package (need to cite Tidyverse somehow) to filter it for those journals awarded the DOAJ Seal, and to remove unneeded columns containing the web addresses for journal policies around plagiarism, submission fees, and other urls not related to this study.
...
A sample of the doaj_seal.csv data set is shown below.  The complete data set is available in searchable and  broweseable format in the  [Annex](#annex-table) near the end of this document.
...
1. 'Data Policy'  (Boolean)
    a. Yes | No

1. 'Data Sharing Policy' (Factor)
    a. No mention 
    a. Implied
    a. Mentioned
    a. Explicitly encouraged
    a. Required, but not explicitly tied to editorial decisions
    a. Required as a condition of publication

1. 'Data Citation Policy' (Factor)
    a. No mention 
    a. Implied
    a. Explicitly encouraged
...
|:------:|:-------|:-----------|:----------|:-------------|
|1| `doaj_seal.csv` |raw data set downloaded from DOAJ site| CSV file, plain text format, 2.7 MB   |    |
|2| `doaj_seal_enhanced.csv` | enhanced data set with new data | CSV file, plain text format, 2.7 MB   |    |
|3| Data set documentation | json metadata file | plain text file, .1 MB |   |
|4| Data Processing steps  | R scripts and comments | R Notebook file, 1 MB |   |
|5| Data Visualizations  | R scripts and documentation; Plots | R Notebook file, .png image files 4 MB |   |
|6| Journal article | Rendered report | RMarkdown, 9 MB|  |
...
*This data table was compiled using the DT package by Xie (2018)*
...
This is auto-populated from your ORCID profile using the  rorcid package. (cite the package).

||> insert code from insert_orcid.R <||
